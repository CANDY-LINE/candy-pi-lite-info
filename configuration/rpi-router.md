...
なお、モバイルネットワークに接続していない状態ではアクセスポイントのSSIDは利用できません。その場合でも、モバイルネットワークに再接続すると再びSSIDが利用可能です（**👉[`candy-pi-lite-service v7.0.3`](https://forums.candy-line.io/t/v7-0-3)以降で対応**）。

...
* [セットアップの仕方](setup/README.md)
  ...
  * [CANDY Pi Lite 3Gモデルの組み立て](setup/assemble-3g.md)
  * [CANDY Pi Lite LTEモデルの組み立て](setup/assemble-lte.md)
...
* [CANDY Pi Lite/+ 設定変更](configuration/README.md)
  ...
  * [モバイルネットワークへの接続設定](configuration/connection.md)
  ...
  * [IP到達確認監視](configuration/ip-reachability-test.md)
